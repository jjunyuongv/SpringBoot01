...
public class MyController
{
    ...
    private final Ex10ValidationUtilsApplication ex10ValidationUtilsApplication;

    MyController(Ex10ValidationUtilsApplication ex10ValidationUtilsApplication) {
        this.ex10ValidationUtilsApplication = ex10ValidationUtilsApplication;
    }
	@GetMapping("/")		
