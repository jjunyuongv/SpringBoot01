...
<html>
	...
	<body>
		...
		<!-- 
		 ...
		 -->
		<!-- num1은 아무값도 출력되지 않는다. -->
		스크립틀에서 선언한 변수 : ${ num1 } <br />
		page 영역에 저장된 변수 : ${ num2 } <br />
		<!-- 
	   		톰켓8.0부터는 EL 에서 변수할당을 할수 있다. 하지만 변수할당과 동시에
		...
		num1 - num2 : ${ num1 - num2 } <br />
		num1 * num2 : ${ num1 * num2 } <br />
		<!-- 나눗셈에서 /와 div연산자를 사용할 수 있다. 또한 자동형변환이 적용되므로
    	정수끼리의 연산에서 실수의 결과가 나올 수 있다. -->
		...
		<!-- 
	    	...
	    	== : eq(EQual)
	    	!= : ne(Not Equal)
	    	Java에서 사용하던 기본적인 비교연산자와 문자형태의 연산자 두가지
	    	모두 사용할 수 있다.
	     -->
		<h3>비교 얀산자</h3>
