 ...
 * Generated at: 2025-05-18 05:24:24 UTC
...
public final class Pass_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		function validateForm(form) { // 비밀번호 확인 JS\r\n");
      ...
      out.write("		<!-- \r\n");
      out.write("			글쓰기 페이지를 복사하여 해당 페이지를 만들때 비밀번호 검증시에는\r\n");
      out.write("			첨부파일이 필요 없으므로 enctype은 제거해야 한다. 만약 제거하지 않으면\r\n");
      out.write("			request내장객체로 폼값을 받을 수 없으므로 주의해야 한다.\r\n");
      out.write("		 -->\r\n");
      out.write("		<form name=\"writeFrm\" method=\"post\" action=\"../mvcboard/pass.do\" onsubmit=\"return validateForm(this);\">\r\n");
      out.write("		<!-- \r\n");
      out.write("			해당 요청명으로 넘어온 파라미터는 컨트롤러에서 받은 후 \r\n");
      out.write("			request영역에 저장하여 View에서 확인할 수 있지만, EL을 \r\n");
      out.write("			이용하면 해당 과정없이 param내장객체로 즉시 값을 받아올 \r\n");
      out.write("			수 있다.\r\n");
      out.write("			\r\n");
      out.write("			* hidden박스를 사용하는 경우 웹브라우져에서는 숨김처리 \r\n");
      out.write("			되기때문에 값이 제대로 입력되었는지 화면으로 확인할 수 \r\n");
      out.write("			없다. 따라서 개발자 모드를 사용하거나 type을 디버깅용\r\n");
      out.write("			으로 잠깐 수정한 후 값이 제대로 입력되었는지 반드시 \r\n");
      out.write("			확인해야 한다.\r\n");
      out.write("		 -->\r\n");
